...
enum SiteFieldsEnum {
  ...
  siteMetadata___social = 'siteMetadata.social',
  siteMetadata___social___name = 'siteMetadata.social.name',
  siteMetadata___social___url = 'siteMetadata.social.url',
  polyfill = 'polyfill',
...
enum SitePageFieldsEnum {
  ...
  pluginCreator___pluginOptions___excerpt_separator = 'pluginCreator.pluginOptions.excerpt_separator',
  ...
  pluginCreator___pluginOptions___aliases___sh = 'pluginCreator.pluginOptions.aliases.sh',
  pluginCreator___pluginOptions___aliases___js = 'pluginCreator.pluginOptions.aliases.js',
  pluginCreator___pluginOptions___aliases___py = 'pluginCreator.pluginOptions.aliases.py',
  ...
  pluginCreator___pluginOptions___languageExtensions = 'pluginCreator.pluginOptions.languageExtensions',
  pluginCreator___pluginOptions___languageExtensions___language = 'pluginCreator.pluginOptions.languageExtensions.language',
  pluginCreator___pluginOptions___languageExtensions___extend = 'pluginCreator.pluginOptions.languageExtensions.extend',
  pluginCreator___pluginOptions___prompt___user = 'pluginCreator.pluginOptions.prompt.user',
  pluginCreator___pluginOptions___prompt___host = 'pluginCreator.pluginOptions.prompt.host',
  pluginCreator___pluginOptions___prompt___global = 'pluginCreator.pluginOptions.prompt.global',
...
enum SitePluginFieldsEnum {
  ...
  pluginOptions___plugins___pluginOptions___indentedSyntax = 'pluginOptions.plugins.pluginOptions.indentedSyntax',
  pluginOptions___plugins___pluginOptions___indentType = 'pluginOptions.plugins.pluginOptions.indentType',
  pluginOptions___plugins___pluginOptions___indentWidth = 'pluginOptions.plugins.pluginOptions.indentWidth',
  pluginOptions___plugins___pluginOptions___linefeed = 'pluginOptions.plugins.pluginOptions.linefeed',
  pluginOptions___plugins___pluginOptions___omitSourceMapUrl = 'pluginOptions.plugins.pluginOptions.omitSourceMapUrl',
  pluginOptions___plugins___pluginOptions___precision = 'pluginOptions.plugins.pluginOptions.precision',
  pluginOptions___plugins___pluginOptions___sourceComments = 'pluginOptions.plugins.pluginOptions.sourceComments',
  pluginOptions___plugins___pluginOptions___sourceMapContents = 'pluginOptions.plugins.pluginOptions.sourceMapContents',
  pluginOptions___plugins___pluginOptions___sourceMapEmbed = 'pluginOptions.plugins.pluginOptions.sourceMapEmbed',
  ...
  pluginOptions___plugins___pluginOptions___languageExtensions = 'pluginOptions.plugins.pluginOptions.languageExtensions',
  ...
  pluginOptions___excerpt_separator = 'pluginOptions.excerpt_separator',
  ...
  pluginOptions___aliases___sh = 'pluginOptions.aliases.sh',
  pluginOptions___aliases___js = 'pluginOptions.aliases.js',
  pluginOptions___aliases___py = 'pluginOptions.aliases.py',
  ...
  pluginOptions___languageExtensions = 'pluginOptions.languageExtensions',
  pluginOptions___languageExtensions___language = 'pluginOptions.languageExtensions.language',
  pluginOptions___languageExtensions___extend = 'pluginOptions.languageExtensions.extend',
  pluginOptions___prompt___user = 'pluginOptions.prompt.user',
  pluginOptions___prompt___host = 'pluginOptions.prompt.host',
  pluginOptions___prompt___global = 'pluginOptions.prompt.global',
...
type SitePluginPluginOptionsAliases = {
  ...
  readonly js: Maybe<Scalars['String']>;
  readonly py: Maybe<Scalars['String']>;
};

type SitePluginPluginOptionsAliasesFilterInput = {
  readonly sh: Maybe<StringQueryOperatorInput>;
  readonly js: Maybe<StringQueryOperatorInput>;
  readonly py: Maybe<StringQueryOperatorInput>;
};
...
type FooterQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'author' | 'twitterUrl'>> }>, readonly avatar: Maybe<{ readonly childImageSharp: Maybe<{ readonly fixed: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }> };
...
type HelmetQueryVariables = Exact<{ [key: string]: never; }>;


type HelmetQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type PostQuery = { readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags'>> }
  )> };
...
type TagPostsQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags'>> }> } };
...
type PostsQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'tags'>> }> } };
